...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php _e( get_option('', get_url("inc/themes/backend/default/assets/img/favicon.png")) )?>" />
...
<!-- sidebar-small  -->
<body class="<?php _e( get_option('appearance_default_menu', 0)?"":"sidebar-small" )?>" id="sidebar-<?php _e( get_option('appearance_menu_color', "light") )?>">
	...
	<div class="sidebar">
		...
		<div class="logo">
			<a href="<?php _e( get_url("dashboard") )?>">
				<span class="logo-small"><img src="<?php _e( get_option('', get_url("inc/themes/backend/default/assets/img/logo.png")) )?>"></span>
				<?php if(get_option('appearance_menu_color', "light") == "light"){?>
				<span class="logo-full"><img src="<?php _e( get_option('', get_url("inc/themes/backend/default/assets/img/logo-black.png")) )?>"></span>
				<?php }else{?>
				<span class="logo-full"><img src="<?php _e( get_option('', get_url("inc/themes/backend/default/assets/img/logo-black.png")) )?>"></span>
				<?php }?>
			</a>
...
$js_files = [
	...
	get_theme_backend_path('assets/plugins/ckeditor/ckeditor.js', false),
...
?>
<script type="text/javascript" src="<?php _e( get_url("load/index/js?load=".implode( "," , $js_files) ), false)?>"></script>
